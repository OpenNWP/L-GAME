...
module linear_combine_two_states
  ...
  subroutine lin_combination(state_0,state_1,state_out,coeff_0,coeff_1)
  ...
  subroutine interpolation_t(state_0,state_1,state_out,time_old,time_new,time_write)
    ...
    (time_write-time_old)/(time_new-time_old))
