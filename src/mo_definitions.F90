...
module mo_definitions
  ...
  type t_diag
    ...
    real(wp), allocatable :: p_grad_condensates_w(:,:,:)       ! vertical pressure gradient acceleration due to the gravity of condensates
    ...
    real(wp), allocatable :: power_flux_density_sens_sea(:,:)  ! sensible power flux density at the surface above the sea
    real(wp), allocatable :: power_flux_density_sens_soil(:,:) ! sensible power flux density at the surface above the soil (including lakes)
    real(wp), allocatable :: power_flux_density_lat_sea(:,:)   ! latent power flux density at the surface above the sea
    real(wp), allocatable :: power_flux_density_lat_lake(:,:)  ! latent power flux density at the surface above lakes
