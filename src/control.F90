...
program control
  ...
  allocate(grid%trsk_weights_u(3,ny))
  allocate(grid%trsk_weights_v(2,ny+1))
  ...
  allocate(diag%p_grad_condensates_w(ny,nx,n_levels))
  ...
  allocate(diag%power_flux_density_sens_sea(ny,nx))
  allocate(diag%power_flux_density_sens_soil(ny,nx))
  allocate(diag%power_flux_density_lat_sea(ny,nx))
  allocate(diag%power_flux_density_lat_lake(ny,nx))
  ...
  allocate(diag%mass_diff_coeff_eff_v(ny,nx,n_layers))
  allocate(diag%temp_diff_coeff_eff_h(ny,nx,n_layers))
  allocate(diag%temp_diff_coeff_eff_v(ny,nx,n_layers))
  ...
  diag%p_grad_condensates_w = 0._wp
  ...
  deallocate(diag%p_grad_condensates_w)
